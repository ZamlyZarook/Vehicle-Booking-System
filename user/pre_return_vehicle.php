...
<?php $login_customer = $_SESSION['login_customer']; 
    ...
    $sql1 = "SELECT v.vehicle_number, v.vehicle_type, rv.start_date, rv.end_date, rv.vehicle_id FROM rentedvehicle rv, vehicles v
    WHERE rv.customer_username='$login_customer' AND v.vehicle_id=rv.vehicle_id AND rv.return_status='NR' AND v.vehicle_available='no'";
...
<table class="styled-table">
    ...
    ?>
        <tr>
            ...
            <td><a href="return_vehicle.php?id=<?php echo $row["vehicle_id"];?>&start_date=<?php echo $row["start_date"];?>&end_date=<?php echo $row["end_date"];?>"> Return </a></td>
        </tr>
<?php    } ?>
    </tbody>
</table>
