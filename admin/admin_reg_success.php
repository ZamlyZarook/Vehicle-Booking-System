...
<header>
    ...
    <div class="form-reg"> 
        ...
        <p>Your Admin Registration was successful. You can now log in using your credentials.</p>
        <form>
        <input type="button" value="Admin Login" onclick="location.href='admin_login.php'">
        </form>
    </div>
